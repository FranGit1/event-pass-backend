...
const base_repository_1 = require("../../shared/base/base.repository");
let ExampleRepository = class ExampleRepository extends base_repository_1.BaseRepository {
    constructor(exampleRepository) {
        super(exampleRepository);
        this.exampleRepository = exampleRepository;
    }
};
ExampleRepository = __decorate([
