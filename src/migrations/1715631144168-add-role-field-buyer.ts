...
export class AddRoleFieldBuyer1715631144168 implements MigrationInterface {
    name = 'AddRoleFieldBuyer1715631144168'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."buyer_role_enum" AS ENUM('buyer')`);
        ...
        await queryRunner.query(`CREATE TABLE "event" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "organizer" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "price" character varying NOT NULL, "startdate" TIMESTAMP NOT NULL, "enddate" TIMESTAMP NOT NULL, "keywords" character varying NOT NULL, "featuredimage" character varying NOT NULL, "displayinslider" boolean NOT NULL, "sliderposition" integer NOT NULL, "location_id" integer, "topic_id" integer, CONSTRAINT "REL_ff5c43e186f7faf15a975004d7" UNIQUE ("location_id"), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "organization" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "title" character varying NOT NULL, "keyword" character varying NOT NULL, "organizer" character varying NOT NULL, "legalname" character varying NOT NULL, "slug" character varying NOT NULL, "organizerlogo" character varying NOT NULL, "organizerdescription" character varying, "organizerfacebook" character varying, "organizerlink" character varying, "organizeremail" character varying, "organizerinstagram" character varying, CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`);
